                ...
                e.ajax({
                    ...
                    if (e.status == "success") {
                        ...
                        if (e.type == "ValidationError") {
                            $(".fa-spinner").addClass("opacity-0").removeClass("fa-spin");
                            $(".message").html('<p class="notify-valid">O e-mail que escreveste não é valido<br>Não dês baile e escreve um e-mail correto.</p>').fadeIn();
                        } else {
                            $(".fa-spinner").addClass("opacity-0").removeClass("fa-spin");
                            $(".message").html('<p class="notify-valid">Oops. Parece que deu m****.<br>Vamos tentar outra vez?</p>').fadeIn();
                        }
                    }
                })
            } else {
